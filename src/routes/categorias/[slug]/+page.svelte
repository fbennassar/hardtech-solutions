...
<svelte:head>
  <title>{data.category.name} | HardTech Solutions</title>
</svelte:head>

<div class="container mx-auto px-4 py-8">
  <div class="mb-8 text-center sm:text-left">
    <a href="/productos" class="btn btn-sm btn-ghost mb-4 text-base-content/70">
  ...
  <!-- Re-using generic AddToCart generic action to '/productos?/addToCart' -->
  {#if form?.error}
  ...
  {#if data.products.length === 0}
    ...
    >
      ...
      <p class="text-base-content/70">
        Vuelve pronto para ver el nuevo inventario para {data.category.name}.
      </p>
    </div>
  {:else}
    <div
