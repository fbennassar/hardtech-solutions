...
<h2 class="card-title mb-6 justify-center text-center text-2xl font-bold">Crear Cuenta</h2>
...
>
	...
	<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
		...
		<div class="form-control">
			...
			<select name="accountType" id="accountType" class="select select-bordered w-full" bind:value={accountType}>
	...
	<div class="mt-4 text-center text-sm">
		¿Ya tienes cuenta? <a href="/auth/login" class="link link-primary">Inicia sesión</a>
	</div>
</form>
