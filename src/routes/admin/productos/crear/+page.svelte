...
<div class="container mx-auto px-4 py-8 max-w-4xl">
  <div class="flex items-center gap-4 mb-6">
    ...
    <h1 class="text-3xl font-bold">
      Crear <span class="text-primary">Producto</span>
    </h1>
  </div>
  ...
  >
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="flex flex-col gap-4">
        <h2 class="text-xl font-semibold border-b pb-2">Información Básica</h2>
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="form-control w-full">
          <label class="label" for="images">
            <span class="label-text">Imágenes del Producto</span>
          </label>
          <input
            type="file"
            id="images"
          ...
          <label class="label" for="images">
            <span class="label-text-alt text-base-content/60"
              >Puedes seleccionar múltiples imágenes.</span
            >
          </label>
        </div>
    ...
    <div class="mt-6 flex flex-col gap-4">
      ...
      <div class="form-control w-full">
        ...
        <textarea
          ...
          placeholder="Breve resumen para tarjetas de producto..."
          disabled={loading}
        ></textarea>
      </div>
      ...
      <div class="form-control w-full">
        <label class="label" for="long_description">
          <span class="label-text">Descripción Completa</span>
        </label>
        <textarea
          id="long_description"
          name="long_description"
          class="textarea textarea-bordered h-40"
          placeholder="Detalles completos, especificaciones técnicas, características..."
          disabled={loading}
        ></textarea>
      </div>
    </div>
